...
var Client = (function (_super) {
    ...
    Client.prototype.loadUser = function (user_id) {
    ...
    Client.prototype.loadUsersFromChannel = function (channel_id) {
        var uri = "/channels/" + channel_id + "/members";
        this.logger.info("Loading " + uri);
        return this._apiCall('GET', uri, null, this._onUsersOfChannel);
    };
    Client.prototype.loadMessagesFromChannel = function (channel_id, options) {
        if (options === void 0) { options = {}; }
        var uri = "/channels/" + channel_id + "/posts";
    ...
    Client.prototype.loadChannelLastViewed = function (channel_id, prev_channel_id) {
        if (prev_channel_id === void 0) { prev_channel_id = null; }
        var postData = {
    ...
    Client.prototype.getAllUsers = function () {
        return this.users;
    };
    ...
    Client.prototype.dialog = function (trigger_id, url, dialog) {
        var _this = this;
        var postData = {
    ...
    Client.prototype.editPost = function (post_id, msg) {
        var _this = this;
        var postData = msg;
        ...
        return this._apiCall('PUT', "/posts/" + post_id, postData, function (_data, _headers) {
            _this.logger.debug('Edited post');
        });
    };
    Client.prototype.uploadFile = function (channel_id, file, callback) {
        var _this = this;
        var formData = {
            channel_id: channel_id,
            files: file,
    ...
    Client.prototype._apiCall = function (method, path, params, callback, callback_params, isForm) {
        if (callback_params === void 0) { callback_params = {}; }
